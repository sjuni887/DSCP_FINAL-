...
def main():
    ...
    with st.sidebar:
        st.title("Navigation")
        tab = st.radio("Go to", ["🦙💬 Generative AI Chat", "📊 Data Visualization", "📋 Patient Data", "🧮 Risk Calculator"])

    if tab == "🦙💬 Generative AI Chat":
        ...
        with patient_tab[0]:
            ...
            with st.form(key='add_form'):
                ...
                st.write("Anemia Related Features")
                col1, col2 = st.columns(2)
                with col1:
                ...
                st.write("Kidney Related Features 🩺")
                col1, col2 = st.columns(2)
                with col1:
                ...
                st.write("Transfusion Related Features 💉")
                col1, col2 = st.columns(2)
                with col1:
                ...
                st.write("Surgical and Postoperative Features 🏥")
                col1, col2 = st.columns(2)
                with col1:
