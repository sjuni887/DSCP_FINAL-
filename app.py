...
def main():
    ...
    if st.session_state.page == "chat":
        ...
        st.markdown(f"""
        <iframe width="100%" height="700" src="{power_bi_url}" frameborder="0" allowfullscreen="true" style="border-radius: 15px; border: 2px solid #ccc;"></iframe>
        ...
        with patient_tab[0]:
            ...
            with st.form(key='add_form'):
                ...
                with transfusion_col1:
                    preop_transfusion = st.number_input('Preoptransfusion within 30 days', min_value=0, max_value=21, step=1)
            ...
            if indexno_edit:
                ...
                if not patient_data.empty:
                    ...
                    with st.form(key='edit_form'):
                        ...
                        delete_patient_button = st.form_submit_button(label='Delete Patient Data')
